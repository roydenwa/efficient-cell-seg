...
def context_aware_pcolor(img_3D: np.ndarray, z: int, thresh: float = 0.2,
    ...
    """
    Apply Context Aware Pseudocoloring as a preprocessing step.
    ...
    and blue channel, but the intensity of the red and blue channel is lower compared
    to the green channel and thus the pseudocolor image looks greenish in most cases.
    """
    if z == 0:
